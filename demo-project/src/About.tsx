    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-100 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <nav className="mb-8 flex gap-4">
          ...
          <Link
            to="/about"
            className="px-4 py-2 bg-teal-600 text-white rounded-lg shadow hover:shadow-md transition-shadow"
          >
            About
          </Link>
          <Link
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <p className="text-gray-600 text-lg leading-relaxed mb-4">
            We're building a revolutionary visual editor that makes React
            development accessible to everyone. Our goal is to bridge the gap
            between design and code, allowing developers to work more
            efficiently.
          </p>
          <p className="text-gray-600 text-lg leading-relaxed">
            With our editor, you can visually select elements, modify
            properties, and see changes in real-time without leaving your
            workflow.
          </p>
        </div>
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Get help building your app with AI assistance
                </p>
              </div>
            </li>
            <li className="flex items-start gap-3">
